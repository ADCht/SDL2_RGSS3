        ...
        const bn_digit *in2, size_t in2_size)
{
  ...
  pprod = (bn_digit*)mrb_calloc(mrb, pprod_size, sizeof(pprod[0]));
        ...
        const bn_digit *in2, size_t in2_size)
{
  ...
  sum1 = (bn_digit*)mrb_calloc(mrb, sizeof(sum1[0]), sum1_size);
  ...
  sum2 = (bn_digit*)mrb_calloc(mrb, sizeof(sum2[0]), sum2_size);
  sum2[sum2_size-1U] = bn_add_basic(sum2, in2hi, in2hi_size, in2lo, in2lo_size);
  /* cprod = sum1 * sum2 */
  cprod_size = sum1_size + sum2_size;
  cprod = (bn_digit*)mrb_calloc(mrb, sizeof(cprod[0]), cprod_size);
        ...
        const bn_digit *in1, size_t in1_size)
{
  ...
  sum = (bn_digit*)mrb_calloc(mrb, sum_size, sizeof(sum[0]));
  ...
  cprod = (bn_digit*)mrb_calloc(mrb, cprod_size, sizeof(cprod[0]));
        ...
        const bn_digit *in2, size_t in2_size)
{
  ...
  prem_size = in1_size;
  prem = (bn_digit*)mrb_calloc(mrb, prem_size, sizeof(prem[0]));
  memcpy(prem, in1, in1_size * sizeof(prem[0]));

  /* Allocate memory for the partial product */
  prod_size = in2_size + 2U;
  prod = (bn_digit*)mrb_calloc(mrb, prod_size, sizeof(prod[0]));
        ...
        const bn_digit *in2, size_t in2_size)
{
  ...
  trial_quo = (bn_digit*)mrb_calloc(mrb, trial_quo_size, sizeof(trial_quo[0]));

  /* Determine the trial denominator */
  trial_denom_size = split + 1U;
  trial_denom = (bn_digit*)mrb_calloc(mrb, trial_denom_size, sizeof(trial_denom[0]));
...
bn_compute_divisors(mrb_state *mrb, size_t size, unsigned base)
{
  ...
  divisors = (BignumDivisor*)mrb_calloc(mrb, count + 1, sizeof(divisors[0]));
...
bn_to_str_pow2(mrb_state *mrb, struct Bignum const *in1, unsigned logbase)
{
  ...
  str = (char*)mrb_malloc(mrb, str_len + 2);
...
bn_from_str(mrb_state *mrb, char const *str, size_t str_len, unsigned base)
{
  ...
  str2 = (char*)mrb_malloc(mrb, str_len);
  j = 0;
  for (i = 0; i < str_len; ++i) {
    char const *p;
    unsigned d;
...
cmp_fix_big(mrb_state *mrb, mrb_int left, mrb_value right)
{
  ...
  int cmp = bn_cmp(bigself, (Bignum*)DATA_PTR(right));
  bn_free(mrb, bigself);
  return cmp;
}
...
cmp_big_flt(mrb_state *mrb, mrb_value left, mrb_float right)
{
  ...
  cmp = bn_cmp((Bignum*)DATA_PTR(left), bigright);
...
bignum_cmp(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Bignum <=> Bignum */
    cmp = bn_cmp((Bignum*)DATA_PTR(self), (Bignum*)DATA_PTR(other));
    break;
  default:
    return cmp_coerce(mrb, self, other);
  }
...
big_flt_eq(mrb_state *mrb, mrb_value self, mrb_float other)
{
  ...
  eq = bn_cmp((Bignum*)DATA_PTR(self), bigother) == 0;
...
{
  struct Bignum *bigself = (Bignum*)DATA_PTR(self);
...
bignum_eq(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Bignum == Bignum */
    eq = bn_cmp((Bignum*)DATA_PTR(self), (Bignum*)DATA_PTR(other)) == 0;
    break;
  default:
    return mrb_funcall(mrb, other, "==", 1, self);
  }
...
fix_big_plus(mrb_state *mrb, mrb_int x, mrb_value y, mrb_bool subtract)
{
  ...
  struct Bignum *sum = bn_add(mrb, bigx, (Bignum*)DATA_PTR(y), subtract);
...
big_fix_plus(mrb_state *mrb, mrb_value x, mrb_int y, mrb_bool subtract)
{
  ...
  struct Bignum *sum = bn_add(mrb, (Bignum*)DATA_PTR(x), bigy, subtract);
  mrb_value out = new_bignum(mrb, sum, FIXNUM_CONVERT);
  bn_free(mrb, bigy);
  return out;
}
...
{
  struct Bignum *sum = bn_add(mrb, (Bignum*)DATA_PTR(x), (Bignum*)DATA_PTR(y), subtract);
...
bignum_plus(mrb_state *mrb, mrb_value self)
{
  ...
  case num_float:
    /* Bignum + Float */
    out = mrb_float_value(mrb, bn_to_float((Bignum*)DATA_PTR(self)) + mrb_float(other));
    break;
#endif /* MRB_WITHOUT_FLOAT */
  default:
    out = op_coerce(mrb, self, other, "+");
...
float_plus(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Float + Bignum */
    out = mrb_float_value(mrb, fltself + bn_to_float((Bignum*)DATA_PTR(other)));
    break;
  case num_float:
    /* Float + Float */
...
{
  struct Bignum *bigx = fixnum_to_bignum(mrb, x);
  struct Bignum *out = bn_mul(mrb, bigx, (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *sum = bn_mul(mrb, (Bignum*)DATA_PTR(x), (Bignum*)DATA_PTR(y));
...
fix_big_div(mrb_state *mrb, mrb_int self, mrb_value other)
{
  ...
  bigother = (Bignum*)DATA_PTR(other);
  if (bigother->len == 0) {
    mrb_raise(mrb, mrb_class_get(mrb, "ZeroDivisionError"), "divided by 0");
  }
...
big_fix_div(mrb_state *mrb, mrb_value self, mrb_int other)
{
  ...
  out = bn_div(mrb, (Bignum*)DATA_PTR(self), bigother);
  bn_free(mrb, bigother);
...
big_big_div(mrb_state *mrb, mrb_value self, mrb_value other)
{
  ...
  sum = bn_div(mrb, (Bignum*)DATA_PTR(self), bigother);
...
big_fix_mod(mrb_state *mrb, mrb_value self, mrb_int other)
{
  ...
  bigother = fixnum_to_bignum(mrb, other);
  out = bn_mod(mrb, (Bignum*)DATA_PTR(self), bigother);
  bn_free(mrb, bigother);
...
big_big_mod(mrb_state *mrb, mrb_value self, mrb_value other)
{
  ...
  sum = bn_mod(mrb, (Bignum*)DATA_PTR(self), bigother);
...
float_mod(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Float % Bignum */
    out = mrb_float_value(mrb, F(fmod)(fltself, bn_to_float((Bignum*)DATA_PTR(other))));
    break;
  case num_float:
    /* Float % Float */
...
fixnum_divmod(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Fixnum.divmod(Bignum) */
    out = fix_big_divmod(mrb, fixself, (Bignum*)DATA_PTR(other));
    break;
#ifndef MRB_WITHOUT_FLOAT
  case num_float:
    /* Fixnum.divmod(Float) */
...
bignum_divmod(mrb_state *mrb, mrb_value self)
{
  ...
  case num_fixnum:
    /* Bignum.divmod(Fixnum) */
    out = big_fix_divmod(mrb, (Bignum*)DATA_PTR(self), mrb_fixnum(other));
    break;
  case num_bignum:
    /* Bignum.divmod(Bignum) */
    out = big_big_divmod(mrb, (Bignum*)DATA_PTR(self), (Bignum*)DATA_PTR(other));
    break;
#ifndef MRB_WITHOUT_FLOAT
  case num_float:
    /* Bignum.divmod(Float) */
    out = flt_flt_divmod(mrb, bn_to_float((Bignum*)DATA_PTR(self)), mrb_float(other));
    break;
#endif /* MRB_WITHOUT_FLOAT */
  default:
    out = op_coerce(mrb, self, other, "divmod");
...
float_divmod(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Float.divmod(Bignum) */
    out = flt_flt_divmod(mrb, fltself, bn_to_float((Bignum*)DATA_PTR(other)));
    break;
  case num_float:
    /* Float.divmod(Float) */
...
{
  return quo(mrb, self, bn_to_float((Bignum*)DATA_PTR(self)));
}
...
fixnum_pow(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Fixnum ** Bignum */
    out = fix_big_pow(mrb, fixself, (Bignum*)DATA_PTR(other));
    break;
#ifndef MRB_WITHOUT_FLOAT
  case num_float:
    /* Fixnum ** Float */
...
bignum_pow(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Bignum ** Bignum */
    out = big_big_pow(mrb, bigself, (Bignum*)DATA_PTR(other), FIXNUM_CONVERT);
    break;
#ifndef MRB_WITHOUT_FLOAT
  case num_float:
    /* Bignum ** Float */
...
float_pow(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Float ** Bignum */
    out = mrb_float_value(mrb, F(pow)(fltself, bn_to_float((Bignum*)DATA_PTR(other))));
    break;
  case num_float:
    /* Float ** Float */
...
bignum_rev(mrb_state *mrb, mrb_value self)
{
  ...
  static const bn_digit one = 1;
  struct Bignum *in1 = (Bignum*)DATA_PTR(self);
...
{
  struct Bignum *bigx = fixnum_to_bignum(mrb, x);
  struct Bignum *sum = bn_and(mrb, bigx, (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *sum = bn_and(mrb, (Bignum*)DATA_PTR(x), (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *bigx = fixnum_to_bignum(mrb, x);
  struct Bignum *sum = bn_or(mrb, bigx, (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *sum = bn_or(mrb, (Bignum*)DATA_PTR(x), (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *bigx = fixnum_to_bignum(mrb, x);
  struct Bignum *sum = bn_xor(mrb, bigx, (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *sum = bn_xor(mrb, (Bignum*)DATA_PTR(x), (Bignum*)DATA_PTR(y));
...
{
  struct Bignum *out = bn_lshift(mrb, (Bignum*)DATA_PTR(self), other);
...
fixnum_lshift(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Fixnum << Bignum */
    {
      struct Bignum *bigother = (Bignum*)DATA_PTR(other);
...
{
  struct Bignum *out = bn_rshift(mrb, (Bignum*)DATA_PTR(self), other);
...
bignum_eql(mrb_state *mrb, mrb_value self)
{
  ...
  case num_bignum:
    /* Bignum.eql?(Bignum) */
    eql = bn_cmp((Bignum*)DATA_PTR(self), (Bignum*)DATA_PTR(other)) == 0;
    break;
  default:
    eql = FALSE;
    break;
...
{
  /* Can we return a Fixnum? */
  mrb_value fix = bignum_to_fixnum((Bignum*)DATA_PTR(self));
...
bignum_coerce(mrb_state *mrb, mrb_value self)
{
  ...
  case num_float:
    /* Bignum.coerce(Float) */
    {
      mrb_float fltself = bn_to_float((Bignum*)(Bignum*)DATA_PTR(self));
      mrb_ary_set(mrb, pair, 0, other);
