...
void GENERATED_TMP_mrb_mruby_bignum_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_bignum_gem_final(mrb_state*);
void GENERATED_TMP_mrb_mruby_regexp_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_regexp_gem_final(mrb_state*);
...
mrb_final_mrbgems(mrb_state *mrb) {
  ...
  GENERATED_TMP_mrb_mruby_bignum_gem_final(mrb);
  GENERATED_TMP_mrb_mruby_regexp_gem_final(mrb);
}
...
mrb_init_mrbgems(mrb_state *mrb) {
  ...
  GENERATED_TMP_mrb_mruby_bignum_gem_init(mrb);
  GENERATED_TMP_mrb_mruby_regexp_gem_init(mrb);
